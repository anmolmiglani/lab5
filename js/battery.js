...
// This is where we are getting the id of the battery image element
...
function updateBatteryStatus(battery) {
  ...
  // Constructing the URL for the Robohash API with the battery percentage
  const robohashURL = `https://robohash.org/${batteryPercentage}.png`;

  // Update the HTML page with the new image
